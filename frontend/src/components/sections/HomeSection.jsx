    ...
    <div style={{
      ...
      <div style={{ maxWidth: "800px", padding: "0 2rem" }}>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(2.5rem,6vw,4.5rem)",
          ...
          Welcome to <span style={{ color: "#c9a96e" }}>Rising Sun</span>
        </h2>
        <p style={{ fontSize: "clamp(1rem,1.5vw,1.3rem)", fontWeight: 300,
          color: "rgba(245,240,235,0.9)", maxWidth: "600px", margin: "0 auto",
          textShadow: "0 2px 20px rgba(0,0,0,0.6)", lineHeight: 1.7 }}>
          Where love outshines the setting sun. A premium memory care community in Sacramento,
          offering a 3:1 staff‑to‑resident ratio and personalized, holistic care.
        </p>
      </div>
    </div>
  );
